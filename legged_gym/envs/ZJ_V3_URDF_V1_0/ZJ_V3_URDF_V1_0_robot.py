...
from .ZJ_V3_URDF_V1_0_config import ZJ_V3_URDF_V1_0RoughCfg

class ZJ_V3_URDF_V1_0(LeggedRobot):
    cfg: ZJ_V3_URDF_V1_0RoughCfg
    ...
    def _compute_torques(self, actions):
        ...
        #pd controller
        # print("##########################################################################")
        # print("default_dof_pos device:", self.default_dof_pos.device)
        # print("dof_pos device:", self.dof_pos.device)
